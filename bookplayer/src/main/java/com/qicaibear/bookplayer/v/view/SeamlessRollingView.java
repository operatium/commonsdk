package com.qicaibear.bookplayer.v.view;
...
public class SeamlessRollingView extends ConstraintLayout {
    ...
    public void initView(Context context, float whbi, Size viewSize, String direction, String path) {
        ...
        LayoutParams paramsleft, paramsright;
        switch (direction) {
            case "left":
                translationX = Float.valueOf(height * whbi).intValue();
                paramsleft = new LayoutParams(translationX, height);
                paramsright = new LayoutParams(translationX, height);
                paramsleft.leftToLeft = LayoutParams.PARENT_ID;
            ...
            case "right":
                ...
                paramsleft = new LayoutParams(translationX, height);
                paramsright = new LayoutParams(translationX, height);
                paramsright.rightToRight = LayoutParams.PARENT_ID;
            ...
            case "top":
                ...
                paramsleft = new LayoutParams(width, translationY);
                paramsright = new LayoutParams(width, translationY);
                paramsleft.topToTop = LayoutParams.PARENT_ID;
            ...
            case "bottom":
                ...
                paramsleft = new LayoutParams(width, translationY);
                paramsright = new LayoutParams(width, translationY);
                paramsright.bottomToBottom = LayoutParams.PARENT_ID;
        ...
        if (new File(path).exists()) {
            GlideApp.with(left).load(path).into(left);
            GlideApp.with(right).load(path).into(right);
        }
        layout.addView(left);
